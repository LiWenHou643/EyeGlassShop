...
INSERT INTO `defaultdb`.`product` (`id`, `category_id`, `title`, `price`, `discount`, `thumbnail`, `description`) VALUES ('1', '1', 'Glasses 01', '200000', '10', 'this is thumnail', 'good glasses for protect eyes');
